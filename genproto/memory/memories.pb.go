...
var file_memories_proto_rawDesc = []byte{
	...
	,
...
var file_memories_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_memories_proto_goTypes = []any{
	...
	(*Point)(nil),            // 7: memory.Point
	(*Filter)(nil),           // 8: memory.Filter
	(*GetById)(nil),          // 9: memory.GetById
	(*Void)(nil),             // 10: memory.Void
}
var file_memories_proto_depIdxs = []int32{
	7,  // 0: memory.Memory.locations:type_name -> memory.Point
	7,  // 1: memory.MemoryRes.locations:type_name -> memory.Point
	7,  // 2: memory.MemoryCreate.locations:type_name -> memory.Point
	7,  // 3: memory.MemoryCreateBody.locations:type_name -> memory.Point
	7,  // 4: memory.MemoryUpdate.locations:type_name -> memory.Point
	8,  // 5: memory.GetAllReq.filter:type_name -> memory.Filter
	1,  // 6: memory.GetAllRes.memories:type_name -> memory.MemoryRes
	2,  // 7: memory.MemoryService.Create:input_type -> memory.MemoryCreate
	9,  // 8: memory.MemoryService.Get:input_type -> memory.GetById
	5,  // 9: memory.MemoryService.GetAll:input_type -> memory.GetAllReq
	4,  // 10: memory.MemoryService.Update:input_type -> memory.MemoryUpdate
	9,  // 11: memory.MemoryService.Delete:input_type -> memory.GetById
	10, // 12: memory.MemoryService.Create:output_type -> memory.Void
	1,  // 13: memory.MemoryService.Get:output_type -> memory.MemoryRes
	6,  // 14: memory.MemoryService.GetAll:output_type -> memory.GetAllRes
	10, // 15: memory.MemoryService.Update:output_type -> memory.Void
	10, // 16: memory.MemoryService.Delete:output_type -> memory.Void
